...
contract NawahToken is Initializable, ERC20Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable {
    ...
    function withdrawFeeCollector() external nonReentrant {
    ...
    function withdrawSupportFund() external nonReentrant {
    ...
    // UUPS authorization: only owner can upgrade implementation
